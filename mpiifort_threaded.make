...
#CCOPTS = -O0 -g -pthread
CCOPTS = -O3 -g -ipo -no-prec-div -axCORE-AVX-I,AVX,SSE4.2 -xSSE2 -msse2 -pthread
MOPTS = -save
MBOPTS = -save
LOPTS = -lpthread
LEGACY =
...
MPOBJS = MacMPf77_ie.o LnxMP_ie.o LPProcessors_ie.o
...
new_mpbeps32.out : new_mpbeps32_ie.o $(MGESOBJS) $(ESOBJS) $(MESOBJS) $(MPIOBJS) \
                   $(MPOBJS)
	$(MPIFC) $(OPTS90) $(LOPTS) -o new_mpbeps32.out \
    new_mpbeps32_ie.o $(MGESOBJS) $(ESOBJS) $(MESOBJS) $(MPIOBJS) $(MPOBJS) $(LIBS)
...
MacMPf77_ie.o : MacMPf77_ie.c
	$(CC) $(CCOPTS) -c MacMPf77_ie.c
...
LnxMP_ie.o : LnxMP_ie.c
	$(CC) $(CCOPTS) -c LnxMP_ie.c

LPProcessors.o : LPProcessors.c
	$(CC) $(CCOPTS) -c LPProcessors.c

LPProcessors_ie.o : LPProcessors_ie.c
	$(CC) $(CCOPTS) -c LPProcessors_ie.c
...
new_mpbeps32_ie.o : new_pbeps32_ie2.f mpsimul32mod.o pfield32mod.o pdiag32mod.o \
		mp0mod.o
	$(FC90) $(OPTS90) $(MOPTS) -o new_mpbeps32_ie.o -c new_pbeps32_ie2.f
