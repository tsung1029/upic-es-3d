...
OPTS90 = -O0 -g -qautodbl=dbl4 -qzerosize
#OPTS90 = -O4 -qarch=450d -qtune=450d -qautodbl=dbl4 -qzerosize
OPTS77 = $(OPTS90)

CCOPTS = -O0 -g -I/bgsys/drivers/ppcfloor/arch/include
#CCOPTS = -O4 -qarch=450d -qtune=450d  -I/bgsys/drivers/ppcfloor/arch/include
MOPTS = -s
MBOPTS = -s
LOPTS =
LEGACY =
...
ZLIB_LIBPATH = -L/usr/local/tools/zlib-1.2.3/lib -lz


INCPATH = $(HDF_INCPATH)
LIBPATH = $(HDF_LIBPATH) $(ZLIB_LIBPATH)
...
new_pbeps32_ie.out : new_pbeps32_ie.o $(SYSOBJS) $(GESOBJS) $(GESOBJSIE) $(ESOBJS) $(ESOBJSJF) $(ESOBJSIE) $(MPIOBJS) $(NPOBJS)
