...
new_pbeps32_ie.out : new_pbeps32_ie.o $(ESOBJ) $(MESOBJS) $(MGEMOBJS) $(EMOBJS) $(NPOBJS) \
			$(MEMOBJS) $(DESOBJS) $(MPIOBJS) $(MPOBJS) $(MPIFC) $(OPTS90) $(LOPTS) -o new_pbeps32_ie.out \
...
pdb_write32_ie.o : pdb_write32_ie.f
	$(FC90) $(OPTS90) -c pdb_write32_ie.f

pinit32mod_jf.o : pinit32mod_jf.f
	$(FC90) $(OPTS90) -c pinit32mod_jf.f

prbpush32mod_jf.o : prbpush32mod_jf.f
	$(FC90) $(OPTS90) -c prbpush32mod_jf.f

prbpush32mod_ie.o : prbpush32mod_ie.f
	$(FC90) $(OPTS90) -c prbpush32mod_ie.f

ppush32mod_ie.o : ppush32mod_ie.f
	$(FC90) $(OPTS90) -c ppush32mod_ie.f
...
psimul32mod_ie.o : psimul32mod_ie.f
	$(FC90) $(OPTS90) -c psimul32mod_ie.f

p32mod_ie.o : p32mod_ie.f
	$(FC90) $(OPTS90) -c p32mod_ie.f

ext_driver32_jf.o : ext_driver32_jf.f
	$(FC90) $(OPTS90) -c ext_driver32_jf.f

p32mod_jf.o : p32mod_jf.f
	$(FC90) $(OPTS90) -c p32mod_jf.f
