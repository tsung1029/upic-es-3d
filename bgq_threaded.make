...
#OPTS90 = -O0 -g -qautodbl=dbl4 -qzerosize -qextname
OPTS90 = -O4 -qarch=qp -qtune=qp -qautodbl=dbl4 -qzerosize -qextname
OPTS77 = $(OPTS90)

#CCOPTS = -O0 -g
CCOPTS = -O4 -qarch=qp -qtune=qp
MOPTS = -s
MBOPTS = -s
LOPTS =
LEGACY =
...
MPOBJS = MacMPf77.o LnxMP.o LPProcessors_ie.o
