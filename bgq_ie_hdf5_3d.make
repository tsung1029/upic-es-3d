...
OPTS90 = -O4 -qarch=qp -qtune=qp -qautodbl=dbl4 -qzerosize
OPTS77 = $(OPTS90)
...
HDF_VERSION = 1.8.5
HDF_DIR = /usr/local/tools/hdf5/hdf5-$(HDF_VERSION)/parallel
HDF_LIBPATH = -L$(HDF_DIR)/lib -lhdf5_fortran -lhdf5  -lhdf5_hl -lhdf5hl_fortran
HDF_INCPATH = -I$(HDF_DIR)/include

ZLIB_LIBPATH = -L/usr/local/tools/zlib-1.2.6/lib -lz
