...
!     integer :: npxyz, npxyzb, np, npxyzi, npxyzbi, npi
      ...
      complex, dimension(:,:,:,:,:), pointer :: fxyzs, bxyzs
...
! in fourier space, bxyz = magnetic field
      ...
      allocate(bxyzs(3,nyv,kxyp,nzpmx*jbmin*lbmin,jblok*lblok))
...
! transform charge and current to fourier space
!     isign = -1
!     call fftn(qe,cu,qs,fxyzs,qt,cut,isign,mixup,sct,tfft,indx,indy,ind&
...
!    &trt,kxyp,kyp,kyzp,kzp,kblok,mblok,inorder)
! transform electric and magnetic fields to real space
!     isign = 1
!     call fftn(fxyze,bxyze,fxyzs,bxyzs,fxyzt,bxyzt,isign,mixup,sct,tfft&
!    &,indx,indy,indz,kstrt,kxyp,kyp,kyzp,kzp,kblok,mblok,inorder)
