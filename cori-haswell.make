...
OPTS90 = -O3 -r8 -ipo -no-prec-div -xSSE2 -msse2
OPTS77 = $(OPTS90)

CCOPTS = -O3 -ipo -no-prec-div -xSSE2 -msse2
MOPTS = -s
MBOPTS = -s
LOPTS =
LEGACY =
...
new_pbeps32_ie.out : new_pbeps32_ie.o $(SYSOBJS) $(GESOBJSIE) $(ESOBJS) $(ESOBJSJF) $(ESOBJSIE) $(MPIOBJS) $(NPOBJS) nullLOG.o
	$(MPIFC) $(OPTS90) $(LOPTS) -o new_pbeps32_ie.out \
	new_pbeps32_ie.o $(SYSOBJS) $(GESOBJS) $(GESOBJSIE) $(ESOBJS) $(ESOBJSJF) $(ESOBJSIE) $(MPIOBJS) $(NPOBJS) nullLOG.o $(HDF_LIBPATH)
