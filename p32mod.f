...
!
         subroutine ipmove32(part,edges,npp,tmove,ny,nz,kstrt,nvpy,nvpz,&
...
!
         subroutine iwpmoves32(part,edges,npp,tmove,ny,nz,kstrt,nvpy,nvp&
