...
#OPTS90 = -O0 -g -r8
#OPTS90 = -O3 -s real64
OPTS90 = -O3 -r8 -ipo -no-prec-div -axCORE-AVX-I,AVX,SSE4.2 -xSSE2 -msse2
#OPTS90 = -O3 -r8
OPTS77 = $(OPTS90)
#OPTS90 = -r8 -xSSE4.1 -fp-model source -assume minus0
#OPTS77 = -r8 -xSSE4.1 -fp-model source -assume minus0
...
CCOPTS = -O3 -ipo -no-prec-div -axCORE-AVX-I,AVX,SSE4.2 -xSSE2 -msse2
MOPTS = -s
MBOPTS = -s
LOPTS =
LEGACY =
